...
var Operations = map[string]Operation{
	...
	"State_interfaces":    {ID: "State_interfaces", Method: "GET", Path: "/api/v1/state/interfaces", Summary: "Interfaces as retrieved from VPP by the agent, with the latest counters", PathParams: nil, QueryParams: nil, Body: false},
