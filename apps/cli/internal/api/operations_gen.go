...
var Operations = map[string]Operation{
	...
	"Srv6_state":          {ID: "Srv6_state", Method: "GET", Path: "/api/v1/state/srv6", Summary: "SRv6 local SIDs (with good/bad counters), policies and steering of this agent, joined with the running VRF names", PathParams: nil, QueryParams: nil, Body: false},
