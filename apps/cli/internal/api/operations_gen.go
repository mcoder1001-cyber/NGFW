...
var Operations = map[string]Operation{
	...
	"Bonding_bonds":       {ID: "Bonding_bonds", Method: "GET", Path: "/api/v1/state/interfaces/bonds", Summary: "Bond interfaces: live state from VPP (agent BondState: mode, load balance, members with LACP actor/partner state, active member count) merged with the running configuration and pending candidate changes", PathParams: nil, QueryParams: nil, Body: false},
