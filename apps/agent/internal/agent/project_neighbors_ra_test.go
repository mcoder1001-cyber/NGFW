...
// newSvcGlobals is newSvc with the D-071 globals-owner flag set as given and slot 7's id range (TD-8b: proxy-ARP
// tables come from the agent's id range; this file's documents use tables 7xxx).
