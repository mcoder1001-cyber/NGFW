...
var Operations = map[string]Operation{
	...
	"BridgeL2_bridgeDomainMacs": {ID: "BridgeL2_bridgeDomainMacs", Method: "GET", Path: "/api/v1/state/l2/bridge-domains/{id}/macs", Summary: "L2 FIB of one bridge domain (agent BridgeDomainMacs, server-side paged, ordered by MAC)", PathParams: []string{"id"}, QueryParams: []string{"page", "pageSize"}, Body: false},
	"BridgeL2_bridgeDomains":    {ID: "BridgeL2_bridgeDomains", Method: "GET", Path: "/api/v1/state/l2/bridge-domains", Summary: "Bridge domains: live state from VPP (agent BridgeDomainState: members, BVI, flags, learned-MAC count) merged with the running configuration and pending candidate changes", PathParams: nil, QueryParams: nil, Body: false},
