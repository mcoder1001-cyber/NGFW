import en from '../../../locales/en/ipfix-sflow.json';
import fa from '../../../locales/fa/ipfix-sflow.json';
import { describe, expect, it } from 'vitest';

// S-web-polish: the ipfix-sflow namespace ships the same keys in en and fa, and fa is actually translated.
