...
var Operations = map[string]Operation{
	...
	"MplsSrmpls_fib":      {ID: "MplsSrmpls_fib", Method: "GET", Path: "/api/v1/state/routing/mpls/fib", Summary: "Live MPLS FIB of one MPLS table, paged by the agent, with each entry’s paths", PathParams: nil, QueryParams: []string{"label", "page", "pageSize", "table"}, Body: false},
	"MplsSrmpls_tunnels":  {ID: "MplsSrmpls_tunnels", Method: "GET", Path: "/api/v1/state/routing/mpls/tunnels", Summary: "Live MPLS tunnels (this system’s and untagged ones) with their paths and out labels", PathParams: nil, QueryParams: nil, Body: false},
