...
slot: 12 → VRX_TEST_PREFIX=w12  VRX_HTTP_PORT=31200  VRX_WEB_PORT=51200  VRX_METRICS_PORT=9221  VRX_AGENT_SOCKET=/run/vrx-test/w12/agent.sock  VRX_PG_DATABASE=vrx_w12  VRX_VPP_TABLE_BASE=12000  (confirm with `tools/lab env 12`)
