...
var Operations = map[string]Operation{
	...
	"Wireguard_keypair":   {ID: "Wireguard_keypair", Method: "POST", Path: "/api/v1/actions/vpn/wireguard/keypair", Summary: "Generate a WireGuard key pair: the private key is stored as secret key/<name> (never returned); returns the reference and the public key", PathParams: nil, QueryParams: nil, Body: true},
	"Wireguard_state":     {ID: "Wireguard_state", Method: "GET", Path: "/api/v1/state/vpn/wireguard", Summary: "WireGuard interfaces and peers: handshake state, learnt endpoint, last handshake, interface counters (no keys but public ones)", PathParams: nil, QueryParams: []string{"interface"}, Body: false},
}
