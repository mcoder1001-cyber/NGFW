...
| **S6 freeze** | INTEGRATE-E2E (tri topology only if VMs exist, else `single` on vrx-a), SECURITY-REVIEW, DOCS-GEN, STATUS-FINAL | every S4 and S5 task merged or parked (encoded as deps) | no red on main; security review findings fixed or logged; final have/have-not report | 19–21 |
