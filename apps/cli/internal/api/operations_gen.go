...
var Operations = map[string]Operation{
	...
	"Lb_flush":            {ID: "Lb_flush", Method: "POST", Path: "/api/v1/actions/lb/vips/{name}/flush", Summary: "Flush the sticky flow table of a load-balancer VIP (lb_flush_vip): established flows are re-hashed over the current servers. 409 unless the VIP is applied and has a server in use", PathParams: []string{"name"}, QueryParams: nil, Body: false},
	"Lb_vips":             {ID: "Lb_vips", Method: "GET", Path: "/api/v1/state/lb/vips", Summary: "Load-balancer VIPs of the running configuration as VPP holds them: VPP entries (removed copies included), VIP type, servers in use or removed (agent LbState)", PathParams: nil, QueryParams: []string{"name"}, Body: false},
