...
var Operations = map[string]Operation{
	...
	"Nat44EdSessions_kill":     {ID: "Nat44EdSessions_kill", Method: "POST", Path: "/api/v1/actions/nat/sessions/kill", Summary: "Delete one NAT44-ED session by its 5-tuple (protocol, inside and external endpoint) and inside VRF", PathParams: nil, QueryParams: nil, Body: true},
	"Nat44EdSessions_sessions": {ID: "Nat44EdSessions_sessions", Method: "GET", Path: "/api/v1/state/nat/sessions", Summary: "NAT44-ED sessions of this agent, server-side paged (pageSize ≤ 1000) and filtered by the agent (NatSessions RPC)", PathParams: nil, QueryParams: []string{"external", "inside", "outside", "page", "pageSize", "port", "protocol", "vrf"}, Body: false},
	"Nat44EdSessions_summary":  {ID: "Nat44EdSessions_summary", Method: "GET", Path: "/api/v1/state/nat/summary", Summary: "NAT44-ED totals and per-pool utilisation (NatSummary RPC) joined with the running configuration pool names", PathParams: nil, QueryParams: nil, Body: false},
