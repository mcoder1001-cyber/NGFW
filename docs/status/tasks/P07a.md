...
Run on `9eedff9` (the docs-only commit that follows changes no code):
```
...
== summary (quick) ==
  ...
  apps/agent: make lint test build                   0m09s
  ...
  warnings:
    - commit subject(s) not in Conventional Commits form (type(scope): subject):
      review(P07a): findings
  mode quick · wall time 2m06s · logs /root/ngfw-wt/logs/ci/P07a-20260924-011337-1188206
