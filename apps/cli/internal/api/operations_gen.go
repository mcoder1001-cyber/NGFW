...
var Operations = map[string]Operation{
	...
	"IpfixSflow_ipfix":    {ID: "IpfixSflow_ipfix", Method: "GET", Path: "/api/v1/state/ipfix", Summary: "IPFIX exporters, flowprobe and sFlow interfaces and sampling counters as the data plane has them (agent IpfixState)", PathParams: nil, QueryParams: nil, Body: false},
	...
	"QosFlat_policers":    {ID: "QosFlat_policers", Method: "GET", Path: "/api/v1/state/services/qos/policers", Summary: "QoS policers and shapers: what VPP reports (parameters, token buckets, conform/exceed/violate counters) joined with the running configuration (attachments)", PathParams: nil, QueryParams: []string{"name"}, Body: false},
	"QosFlat_reset":       {ID: "QosFlat_reset", Method: "POST", Path: "/api/v1/actions/qos/policers/{name}/reset", Summary: "Refill a policer's token buckets (VPP policer_reset); the counters are kept. Operator; audited", PathParams: []string{"name"}, QueryParams: nil, Body: false},
	...
	"SnmpState_snmp":      {ID: "SnmpState_snmp", Method: "GET", Path: "/api/v1/state/snmp", Summary: "SNMP agent state: daemon read-back, pending daemon action, VRX-MIB subagent", PathParams: nil, QueryParams: nil, Body: false},
