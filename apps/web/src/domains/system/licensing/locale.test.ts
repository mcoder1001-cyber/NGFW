import en from '../../../locales/en/licensing.json';
import fa from '../../../locales/fa/licensing.json';
import { describe, expect, it } from 'vitest';

// S-web-polish: the licensing namespace ships the same keys in en and fa, and fa is actually translated.
