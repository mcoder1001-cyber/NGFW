...
var Operations = map[string]Operation{
	...
	"RpfAdlPbr_pbr":      {ID: "RpfAdlPbr_pbr", Method: "GET", Path: "/api/v1/state/pbr", Summary: "Policy-based routing: running policies and attachments vs what the agent retrieves from VPP (attachments paged)", PathParams: nil, QueryParams: []string{"page", "pageSize"}, Body: false},
