...
func sentTagged(v *coretest.VPP, names ...string) []string {
	var out []string
...
func TestPhysicalNICAddressAndVRF(t *testing.T) {
	...
	if w := sentTagged(v, "sw_interface_add_del_address", "sw_interface_set_table", "sw_interface_set_flags"); len(w) != 0 {
