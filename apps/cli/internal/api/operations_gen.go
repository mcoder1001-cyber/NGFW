...
var Operations = map[string]Operation{
	...
	"KeaDhcpRelay_client": {ID: "KeaDhcpRelay_client", Method: "GET", Path: "/api/v1/state/interfaces/{name}/dhcp-client", Summary: "VPP DHCPv4 client of one interface: state and lease (dhcp_client_dump)", PathParams: []string{"name"}, QueryParams: nil, Body: false},
	"KeaDhcpRelay_leases": {ID: "KeaDhcpRelay_leases", Method: "GET", Path: "/api/v1/state/dhcp/leases", Summary: "Kea DHCP leases, one page (the agent pages lease4/6-get-page; never the whole lease file), with kea-dhcp4/6 status and per-subnet pool usage", PathParams: nil, QueryParams: []string{"family", "filter", "page", "pageSize", "server"}, Body: false},
	"KeaDhcpRelay_relays": {ID: "KeaDhcpRelay_relays", Method: "GET", Path: "/api/v1/state/dhcp/relays", Summary: "DHCP relays: the running configuration next to what the agent retrieves from VPP (dhcp proxy per client VRF)", PathParams: nil, QueryParams: nil, Body: false},
