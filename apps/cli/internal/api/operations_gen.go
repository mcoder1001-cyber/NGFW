...
var Operations = map[string]Operation{
	...
	"HostAclNftables_hostAcl": {ID: "HostAclNftables_hostAcl", Method: "GET", Path: "/api/v1/state/host-acl", Summary: "Host firewall (nftables table inet vrx): sets, chains and rules with packet/byte counters, mode and in-sync flag", PathParams: nil, QueryParams: nil, Body: false},
	"ObjectModel_fqdn":        {ID: "ObjectModel_fqdn", Method: "GET", Path: "/api/v1/state/objects/fqdn", Summary: "FQDN address objects as the agent resolves them: addresses in use, last resolution, next refresh, latest error", PathParams: nil, QueryParams: []string{"name"}, Body: false},
	"ObjectModel_usage":       {ID: "ObjectModel_usage", Method: "GET", Path: "/api/v1/state/objects/usage", Summary: "Where-used of an object, tag, zone or interface name: group members, tags, ACL rules and attachments, zones", PathParams: nil, QueryParams: []string{"name", "source"}, Body: false},
