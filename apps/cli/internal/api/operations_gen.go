...
var Operations = map[string]Operation{
	...
	"NeighborsRa_arpFlush":  {ID: "NeighborsRa_arpFlush", Method: "POST", Path: "/api/v1/actions/arp-flush", Summary: "Flush learned ARP/ND entries of one interface or of every configured interface; static neighbours stay", PathParams: nil, QueryParams: nil, Body: true},
	"NeighborsRa_neighbors": {ID: "NeighborsRa_neighbors", Method: "GET", Path: "/api/v1/state/neighbors", Summary: "Live ARP/ND table (learned and static neighbours) of the interfaces the agent can name, filtered and paged by the agent", PathParams: nil, QueryParams: []string{"dir", "family", "interface", "page", "pageSize", "search", "sort", "state", "vrf"}, Body: false},
