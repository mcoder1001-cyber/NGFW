...
| **S2 core** | P05 agent core, P06 api core, P07a ui shell → P07b ui flows; DF-1…DF-8, RF-1…RF-4 start the moment P05a merges | S1 (P05a for factories) | each layer's tests green against contracts; factories: descriptor tables committed, integration green on host VPP | 3–5 |
