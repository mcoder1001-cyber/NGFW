...
// detaches its members and deletes its sub-interfaces. Installed by New through the TD-23 RegisterExtension registry (init below).
...
func init() { RegisterExtension("bonding", (*VPP).installBonding) }
