...
// Members of `services` this feature implements, in the shared registry that ServicesUnsupported reads
// (desired/qos_services.go; the branch's own merge seam was dropped when it was ported onto main).
func init() {
	ServicesImplemented["lldp"] = true
	ServicesImplemented["nsim"] = true
}
