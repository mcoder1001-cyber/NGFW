...
const eiPart = `,
  "nat": {
    ...
    "staticMappings": [{"name": "web", "protocol": "tcp", "local": {"ip": "10.7.1.2", "port": 80}, "external": {"ip": "10.7.2.103", "port": 8080}}],
    "nat64": {
...
const canonicalEI = `{
  ...
  "staticMappings": [{"name": "web", "protocol": "tcp", "local": {"ip": "10.7.1.2", "port": 80}, "external": {"ip": "10.7.2.103", "port": 8080}, "twiceNat": false, "selfTwiceNat": false, "out2inOnly": false}],
